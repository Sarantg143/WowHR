...
const OurService = () => {
  ...
  return (
    <section
      id="our-service"
      className="flex flex-col items-center justify-center h-full p-5 mx-auto overflow-hidden bg-white cursor-default md:h-full xl:h-screen xl:p-20 max-w-7xl sm:pb-5 md:pb-10"
    >
      <div
