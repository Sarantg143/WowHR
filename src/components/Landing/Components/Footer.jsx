...
const Footer = () => {
  ...
  return (
    <section
      id="footer"
      className="h-full my-auto overflow-hidden text-white bg-black cursor-default "
    >
      ...
      >
        <div className="mx-auto xl:max-w-7xl">
          ...
          <div className="flex items-center flex-col justify-center xl:px-12 px-4 py-1 pt-3 xl:flex-row xl:pt-1 text-[.65rem] text-white  border-t border-gray-500">
