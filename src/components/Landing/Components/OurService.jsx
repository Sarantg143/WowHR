...
const OurService = () => {
  ...
  return (
    ...
    >
      {
        openNetwork && <div id="confetti_canvas" className="w-screen h-screen absolute z-40 bg-[#00000036] flex items-center justify-center backdrop-blur">
          <div data-aos='fade-down' className=" w-[90%] md:w-[35%] h-fit bg-white shadow-lg rounded-lg p-6 md:p-4 items-center flex-wrap ">
            ...
            <div style={{display:"flex", flexDirection:"column", gap:"0px"}} className="flex items-center justify-center w-full">
              <div className="flex gap-2">  <CountUp end={3500} duration={1} className="font-bold text-[3rem] md:text-[5rem] text-[#102744]" />
                <p className="font-bold text-[3rem] md:text-[5rem] text-[#102744]">+ </p>
              </div>
              <p className="font-bold text-[3rem] md:text-[4rem] text-[#1e4b82] text-center">Users</p>
            </div>
          </div>
        </div>
      }
      ...
      <div
        ...
        data-aos-duration="1000"
      >
        HR and Students community through Skill development, upskilling. We focus
        ...
        we intend to provide exclusive learning experience
          ...
          >
            ...
            >
              ...
              <div className="md:text-lg text-xs xl:text-base font-semibold text-left xl:leading-[1.5] min-h-[3rem] xl:min-h-[5rem]  line-clamp-4">
                  ...
                  India's first no cost job portal, connecting job seekers with oppertunities.
              </div>
